...
<!-- saved from url=(0052)http://sxydb.yanan.gov.cn/Aboutus.asp?Title=经营理念 -->
<HTML>
	<HEAD>
		<TITLE>延安信用担保网</TITLE>
		<STYLE type=text/css>
															...
															<TBODY>
																<TR>
																	<TD background=${pageContext.request.contextPath}/images/menu2bg.gif height=32>
																		...
																		<A class=daohang_link
																			href="${pageContext.request.contextPath}/jsp/aboutus/aboutusIndex.action">企业信息</A>&gt;&gt;&nbsp;
																					...
																					<TR>
																						...
																						<TD style="BORDER-BOTTOM: #999999 1px dotted"
																							...
																							<A title="标题：${info.name }"
																								href="${pageContext.request.contextPath}/jsp/aboutus/showAboutus.action?id=${info.id }"
