...
<!-- saved from url=(0057)http://sxydb.yanan.gov.cn/NewsClass.asp?BigClass=媒体报道 -->
<HTML>
	<HEAD>
		<TITLE>延安信用担保网</TITLE>
		<STYLE type=text/css>
																...
																<TBODY>
																	<TR>
																		<TD align="center" height=24>
																			&nbsp;&nbsp;
																			<INPUT class=input size=28 name=inforname>
																		</TD>
																	</TR>
																	<TR>
																		<TD height=24>
															...
															<TBODY>
																<TR>
																	<TD
																		...
																		<A class=daohang_link
																			href="<%=request.getContextPath() %>/jsp/news/newsIndex.action">新闻资讯</A>&nbsp;&gt;&gt;&nbsp;
																		<SPAN class=daohang_nonce>${SectionName }</SPAN>
																	</TD>
																</TR>
															</TBODY>
														</TABLE>
												...
												<TR>
													<TD
														...
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<TBODY>
															<c:choose>
																<c:when test="${!empty  XYDB_LISTINFO}" >
																<c:forEach var="info" items="${XYDB_LISTINFO}">
																<TR>
																...
																<TR vAlign=bottom>
																	<TD align="center" colSpan=3 height=50>
																		<FORM
																			action=${pageContext.request.contextPath}/jsp/news/newsList.action?
																			method=post>
																			${pagenav }
																			<B>20</B>条记录/页 
																			<!--  转到：
