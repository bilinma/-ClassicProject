<%@ page language="java" contentType="text/html; charset=utf-8"
	import="org.springframework.context.ApplicationContext,org.springframework.context.support.ClassPathXmlApplicationContext,cn.edn.yan.service.InformationService,java.util.*,cn.edn.yan.domain.File"%>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<!-- saved from url=(0045)http://sxydb.yanan.gov.cn/shownews.asp?id=172 -->
		...
		<DIV align=center>
										...
										<TD vAlign=top align=middle width=225
											...
											<TABLE cellSpacing=0 cellPadding=0 width=202 border=0>
												<TBODY>
													...
													<TR>
														<TD align=middle background=${pageContext.request.contextPath}/images/news1.gif
															height=35>
															<DIV
											...
											<TABLE id=AutoNumber4 style="BORDER-COLLAPSE: collapse"
												...
												<TBODY>
													...
													<TR>
														<TD align=middle background=${pageContext.request.contextPath}/images/news_new.gif
															height=35>
															<DIV
																style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
																最新新闻
											...
											<TABLE id=AutoNumber5 style="BORDER-COLLAPSE: collapse"
												...
												<TBODY>
													...
													<TR>
														<TD align=middle background=${pageContext.request.contextPath}/images/news_hot.gif
															height=35>
															<DIV
																style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
																热门新闻
																								...
																								<TBODY>
																									<TR>
																										<TD align=middle bgColor=#ffffcc height=24>
																											<FONT color=#006699>发表日期：</FONT><FONT
																												color=#ff0000> ${XYDB_INFO.createdate } </FONT><FONT
																												color=#006699>编辑录入：</FONT><FONT
																												color=#ff0000>来源：${XYDB_INFO.releaseunit}</FONT>
																											<FONT color=#006699>阅读：</FONT>
																											<FONT color=#ff0000>${XYDB_INFO.scansum }</FONT><FONT color=#006699>次</FONT>
																											【字体：
																									...
																									<TR>
																										<TD bgColor=#ffffcc height=24>
																											<c:forEach var="downfile" items="${XYDB_FILES}">
																												下载&nbsp;<a href="${pageContext.request.contextPath}/jsp/download.action?name=<%=java.net.URLEncoder.encode(((cn.edn.yan.domain.File)pageContext.getAttribute("downfile")).getName(), "UTF-8")%>">${downfile.name }</a>
																											</c:forEach>
																											<!--<B><IMG src="${pageContext.request.contextPath}/images/new_win.gif">&nbsp;上一篇：</B>
																											<A href="http://sxydb.yanan.gov.cn/shownews.asp?id=171">${XYDB_INFOUP.name }</A>-->
																										</TD>
																									</TR>
																									<TR>
																										<TD bgColor=#ffffcc height=24>
																											&nbsp;
																											<!--  <B><IMG src="${pageContext.request.contextPath}/images/new_win.gif">&nbsp;下一篇：</B><A
																												href="http://sxydb.yanan.gov.cn/shownews.asp?id=173">${XYDB_INFONEXT.name }</A>-->
																										</TD>
																									</TR>
																									<TR>
																										<TD></TD>
																				...
																				<TBODY>
																					<TR>
																						<TD vAlign=center width=150>
																							<A class=bottom href="javascript:window.print()"><IMG
																									src="${pageContext.request.contextPath}/images/printer.gif" border=0>&nbsp;打印本页</A>
																						</TD>
																						<TD width=90>
																							<INPUT onclick="window.close();return false;"
																								type=button value=关闭窗口 name=close2>
																						</TD>
																					</TR>
																				</TBODY>
																			</TABLE>
			...
			<DIV align=center>
				<TABLE cellSpacing=0 cellPadding=0 width=992 border=0>
					<TBODY>
						<TR>
							<TD class=w-f align=center
								background=${pageContext.request.contextPath}/images/foot-bg1(1).gif height=33></TD>
						</TR>
						<TR>
							<TD align=middle background="${pageContext.request.contextPath}/"
								...
								公司地址:延安市王家坪办公大楼8号楼
								<BR>
								<FONT color=#999999>页面执行时间：</FONT><FONT color=#ff0000>140.625</FONT>
