...
<!-- saved from url=(0034)http://sxydb.yanan.gov.cn/news.asp -->
<HTML>
	<HEAD>
		<TITLE>延安信用担保网</TITLE>
		<STYLE type=text/css>
	...
	TEXT-DECORATION: none
									...
									<TR>
										...
										<TD vAlign=center align=left width=72>
											<A
												...
												href=" ${pageContext.request.contextPath}/jsp/news/newsIndex.action?mname=新闻资讯"><SPAN
				...
				<TBODY>
					<TR>
						...
						<TD vAlign=bottom width=800
							background=${pageContext.request.contextPath}/images/gov_wMcms_09.gif
							height=27>
							<a href="<%=request.getContextPath() %>/jsp/main.action">网站首页</a><span
								class="STYLE4"> | </span>
							...
							<TBODY>
								<TR>
									<TD vAlign=top align=middle width=225
										background=${pageContext.request.contextPath}/images/news-left-bg.gif
										height=220>
										<!--新闻资讯分类显示-->
										<TABLE cellSpacing=0 cellPadding=0 width=202 border=0>
											<TBODY>
												...
												<TR>
													<TD align=middle
														background=${pageContext.request.contextPath}/images/news1.gif
														height=35>
														<DIV
															...
															<TBODY>
																<c:forEach var="section" items="${XYDB_SECTIONS}">
																	<TR>
																		<TD height=20>
																			<DIV align=center>
																			<A href="<%=request.getContextPath() %>/jsp/news/newsList.action?sectionid=${section.id }">${section.name}</A>
																			</DIV>
																		</TD>
																	</TR>
																	<TR>
																		<TD
																			background=${pageContext.request.contextPath}/images/naSzarym.gif
																			colSpan=2 height=1>
																			<IMG height=1
																				src="${pageContext.request.contextPath}/images/1x1_pix.gif"
																				width=10>
																		</TD>
																	</TR>
																</c:forEach>
										...
										<TABLE id=AutoNumber4 style="BORDER-COLLAPSE: collapse"
											...
											<TBODY>
												...
												<TR>
													<TD align=middle
														background=${pageContext.request.contextPath}/images/news_new.gif
														height=35>
														<DIV
															style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
															最新新闻
												...
												<TR>
													<TD
														...
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<!--最新新闻内容-->
															<TBODY>
																<c:forEach var="news" items="${XYDB_LAESTRINFOS}">
																<TR>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="99%" height=22>
																		<A title=${news.name }
																			href="${pageContext.request.contextPath}/jsp/news/showNews.action?id=${news.id }"
																			target=_blank>&nbsp;·<A
																			title=${news.name }
																			href="${pageContext.request.contextPath}/jsp/news/showNews.action?id=${news.id }"
										...
										<TABLE id=AutoNumber5 style="BORDER-COLLAPSE: collapse"
											...
											<TBODY>
												...
												<TR>
													<TD align=middle
														background=${pageContext.request.contextPath}/images/news_hot.gif
														height=35>
														<DIV
															style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
															热门新闻
												...
												<TR>
													<TD
														...
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<!--热门新闻内容-->
															<TBODY>
															<c:forEach var="news" items="${XYDB_HOTINFOS}">
																<TR>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="99%" height=22>
																		<A title=${news.name }
										...
										<!--热门新闻结束-->
										<!--新闻搜索
										<FORM name=form1 action=searchNews.action method=post>
											<TABLE cellSpacing=0 cellPadding=0 width=202 border=0>
												<TBODY>
													<TR>
														<TD height=10></TD>
													...
													<TR>
														<TD align=middle width=202
															background=${pageContext.request.contextPath}/images/news_s.gif
															height=35>
															<DIV
																style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
																新闻搜索
																...
																<TBODY>
																	<TR>
																		<TD align=middle height=24>
																			&nbsp;&nbsp;
																			<INPUT class=input size=28 name="inforname" value="${inforname }">
																		</TD>
																	</TR>
																	<TR>
																		<TD height=24>
																			&nbsp;&nbsp;
																			<SELECT class=input name=otype>
																				<OPTION class=input value=title selected>
																					新闻标题
																				</OPTION>
																				<OPTION class=input value=msg>
																					新闻内容
																				</OPTION> 
																			</SELECT>
																			&nbsp;&nbsp;&nbsp;
													...
													<TD vAlign=top height=206>
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<TBODY>
																<TR>
																	<TD
																		background=${pageContext.request.contextPath}/images/m1.gif
																		height=32>
																		&nbsp;&nbsp;&nbsp;
																		<IMG height=10
																			src="${pageContext.request.contextPath}/images/icon3.gif"
																			width=10>
																		&nbsp;当前位置：
																		<A class=daohang_link
																			href="<%=request.getContextPath() %>/jsp/main.action">网站首页</A>&gt;&gt;&nbsp;
																		<SPAN class=daohang_nonce>新闻资讯</SPAN>
																	</TD>
																</TR>
																<TR>
																	<TD>
																		<DIV align=center>
																			<IMG
																				src="${pageContext.request.contextPath}/images/ad_new.gif">
																		</DIV>
																	</TD>
																</TR>
																<TR>
																	<TD style="BORDER-RIGHT: #ff9933 1px solid; BORDER-TOP: #ff9933 1px solid; BACKGROUND: #ffffff; BORDER-LEFT: #ff9933 1px solid; BORDER-BOTTOM: #ff9933 1px solid"
																		height=1><div align="center"> </div>
																	<c:forEach var="section" items="${XYDB_SECTIONS}">
																			...
																			<TBODY>
																				<TR>
																					<TD width="21%"
																						...
																						&nbsp;&nbsp;
																						<A class=daohang_link
																							href="${pageContext.request.contextPath}/jsp/news/newsSection.action?sname=${section.name }">
																							${section.name }</A>
																					</TD>
																					<TD width="79%"
																						background=${pageContext.request.contextPath}/images/m2.gif
																			...
																			<TBODY>
																							 	...
																							 	<TR>
																									...
																									<TD style="BORDER-BOTTOM: #999999 1px dotted"
																										...
																										<A title="标题：<%=infor.getName() %> "
																											href="${pageContext.request.contextPath}/jsp/news/showNews.action?id=<%=infor.getId() %>"
																				...
																				<TR>
																					<TD height=8>
																						<DIV align=right>
																							<A
																								href="${pageContext.request.contextPath}/jsp/news/newsSection.action?sname=${section.name }">更多…</A>&nbsp;&nbsp;
																						</DIV>
																					</TD>
																				</TR>
																			</TBODY>
																			...
																			<TBODY>
																				<TR>
																					<TD width="21%"
																						...
																						&nbsp;&nbsp;
																						<A class=daohang_link
																							href="${pageContext.request.contextPath}/jsp/news/newsSection.action?sname=行业资讯">
																							行业资讯</A>
																					</TD>
																					<TD width="79%"
																						background=${pageContext.request.contextPath}/images/m2.gif
																			...
																			<TBODY>
																				...
																				<TR>
																					<TD>
																						<TABLE cellSpacing=0 cellPadding=0 width="100%"
																							...
																							<TBODY>
																								<c:choose>
																								<c:when test="${!empty XYDB_INFO_industryNews }" >
																								<c:forEach var="info"
																									items="${XYDB_INFO_industryNews}">
																									<TR>
																										...
																										<TD style="BORDER-BOTTOM: #999999 1px dotted"
																											width="75%" height=24>
																											<A title="标题：${info.name } "
																												href="${pageContext.request.contextPath}/jsp/news/showNews.action?id=${info.id }"
																												target=_blank>${info.name }</A>
																										</TD>
																										<TD style="BORDER-BOTTOM: #999999 1px dotted"
																											width="19%">
																											<FONT color=#999999>[${info.createdate
																												}](点击<FONT color=#ff0000>${info.scansum }</FONT>) </FONT>
																										</TD>
																									</TR>
																								</c:forEach>
																							</c:when>
																				...
																				<TR>
																					<TD height=8>
																						<DIV align=right>
																							<A
																								href="${pageContext.request.contextPath}/jsp/news/newsSection.action?sname=行业资讯">更多…</A>&nbsp;&nbsp;
																						</DIV>
																					</TD>
																				</TR>
																			</TBODY>
																			...
																			<TBODY>
																				<TR>
																					<TD width="21%"
																						...
																						&nbsp;&nbsp;
																						<A class=daohang_link
																							href="${pageContext.request.contextPath}/jsp/news/newsSection.action?sname=媒体报道">
																							媒体报道</A>
																					</TD>
																					<TD width="79%"
																						background=${pageContext.request.contextPath}/images/m2.gif
																			...
																			<TBODY>
																				...
																				<TR>
																					<TD>
																						<TABLE cellSpacing=0 cellPadding=0 width="100%"
																							...
																							<TBODY>
																								<c:choose>
																								<c:when test="${!empty XYDB_INFO_mediaReport }" >
																								<c:forEach var="info"
																									items="${XYDB_INFO_mediaReport}">
																									<TR>
																										<TD align=middle width="6%" height=24>
																											<IMG height=11
																												src="${pageContext.request.contextPath}/images/arrow_6.gif"
																				...
																				<TR>
																					<TD height=8>
																						<DIV align=right>
																							<A
																								href="${pageContext.request.contextPath}/jsp/news/newsSection.action?sname=媒体报道">更多…</A>&nbsp;&nbsp;
																						</DIV>
																					</TD>
																				</TR>
																			</TBODY>
																			...
																			<TBODY>
																				<TR>
																					<TD width="21%"
																						...
																						&nbsp;&nbsp;
																						<A class=daohang_link
																							href="${pageContext.request.contextPath}/jsp/news/newsSection.action?sname=公司简讯">
																							公司简讯</A>
																					</TD>
																					<TD width="79%"
																						background=${pageContext.request.contextPath}/images/m2.gif
																			...
																			<TBODY>
																				...
																				<TR>
																					<TD>
																						<TABLE cellSpacing=0 cellPadding=0 width="100%"
																							...
																							<TBODY>
																								<c:choose>
																								<c:when test="${!empty XYDB_INFO_corpInfo }" >
																								<c:forEach var="info"
																									items="${XYDB_INFO_corpInfo}">
																									<TR>
																										<TD align=middle width="6%" height=24>
																											<IMG height=11
																												src="${pageContext.request.contextPath}/images/arrow_6.gif"
																				...
																				<TR>
																					<TD height=8>
																						<DIV align=right>
																							<A
																								href="${pageContext.request.contextPath}/jsp/news/newsSection.action?sname=公司简讯">更多…</A>&nbsp;&nbsp;
																						</DIV>
																					</TD>
																				</TR>
																			</TBODY>
		...
		<DIV align=center>
			<TABLE cellSpacing=0 cellPadding=0 width=992 border=0>
				<TBODY>
					<TR>
						<TD class=w-f align=middle background="${pageContext.request.contextPath}/images/foot-bg1(1).gif"
							height=33></TD>
					</TR>
					<TR>
