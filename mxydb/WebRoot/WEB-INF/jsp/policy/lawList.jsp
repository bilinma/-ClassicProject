...
<!-- saved from url=(0059)http://sxydb.yanan.gov.cn/policyClass.asp?BigClass=地方法规 -->
<HTML>
	<HEAD>
		<TITLE>延安信用担保网</TITLE>
		<STYLE type=text/css>
									...
									<TD vAlign=top align="center" width=225
										...
										<TABLE cellSpacing=0 cellPadding=0 width=202 border=0>
											<TBODY>
												...
												<TR>
													<TD align="center" background=${pageContext.request.contextPath}/images/policy.gif height=35>
														<DIV
										...
										<TABLE cellSpacing=0 cellPadding=0 width=202 border=0>
											<TBODY>
												...
												<TR>
													<TD align="center" width=202 background=${pageContext.request.contextPath}/images/policy.gif
														height=35>
														<DIV
															style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
															政策法规搜索
															...
															<TBODY>
																<TR>
																	<TD background=${pageContext.request.contextPath}/images/menu2bg.gif height=32>
																		...
																		<A class=daohang_link
																			href="${pageContext.request.contextPath}/jsp/policy/policyIndex.action">政策法规</A>&nbsp;&gt;&gt;&nbsp;
															...
															<TBODY>
																...
																<TR>
																	...
																	<TD style="BORDER-BOTTOM: #999999 1px dotted"
																		...
																		<A title="标题：${info.name }"
																			href="${pageContext.request.contextPath}/jsp/policy/showNews.action?id=${info.id }"
																...
																<TR vAlign=bottom>
																	<TD align="center" colSpan=3 height=50>
																		<FORM
																			action=${pageContext.request.contextPath}/jsp/policy/lawList.action?
																			method=post>
																			${pagenav }
																			<B>20</B>条记录/页
																			<!--  转到：
				...
				<TBODY>
					...
					<TR>
						<TD align=middle background="" height=87>
							...
							公司地址:延安市财政局办公大楼
							<BR>
							<FONT color=#999999>页面执行时间：</FONT><FONT color=#ff0000>45,220,610.000</FONT><FONT
