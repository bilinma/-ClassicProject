...
<!-- saved from url=(0036)http://sxydb.yanan.gov.cn/policy.asp -->
<HTML>
	<HEAD>
		<TITLE>延安信用担保网</TITLE>
		<STYLE type=text/css>
									...
									<TR>
										...
										<TD vAlign=center align=left width=72>
											<A
												...
												href="${pageContext.request.contextPath}/jsp/policy/policyIndex.action?mname=政策法规"><SPAN
										...
										<TD width=157>
											<A
												href="${pageContext.request.contextPath}/jsp/aboutus/relationUs.action?sname=联系我们"><SPAN
									...
									<TD vAlign=top align=middle width=225
										...
										<TABLE cellSpacing=0 cellPadding=0 width=202 border=0>
											<TBODY>
												...
												<TR>
													<TD align=middle
														background=${pageContext.request.contextPath}/images/policy.gif
														height=35>
														<DIV
																...
																<c:forEach var="section" items="${XYDB_SECTIONS}">
																	<TR>
																		<TD height=20>
																			<DIV align=center>
																				<A
																					href="<%=request.getContextPath() %>/jsp/policy/lawList.action?sectionid=${section.id}">${section.name
																					}</A>
																			</DIV>
																		</TD>
																	</TR>
											...
											<TBODY>
												...
												<TR>
													<TD vAlign=center align=middle
														background=${pageContext.request.contextPath}/images/policy_new.gif
														height=35>
														<DIV
															style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
															最新政策法规
															...
															<TBODY>
																...
																<TR>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		...
																		<A title=${news.name }
																			href="${pageContext.request.contextPath}/jsp/policy/showPolicy.action?infoId=${news.id}"
										...
										<TABLE id=AutoNumber5 style="BORDER-COLLAPSE: collapse"
											...
											<TBODY>
												...
												<TR>
													<TD align=middle
														background=${pageContext.request.contextPath}/images/policy_hot.gif
														height=35>
														<DIV
															style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
															热门政策法规
																...
																<c:forEach var="news" items="${XYDB_HOTINFOS}">
																	<TR>
																		<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																			align=left width="99%" height=22>
																			<A title=${news.name }
																				href="${pageContext.request.contextPath}/jsp/policy/showPolicy.action?id=${news.id }"
																				target=_blank>&nbsp;·${news.name }</A>
																		</TD>
																	</TR>
																</c:forEach>
													...
													<TD
														...
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<TBODY>
																<TR>
																	<TD
																		background=${pageContext.request.contextPath}/images/menu2bg.gif
																		height=32>
																		&nbsp;&nbsp;&nbsp;
																		<IMG height=10
																		...
																		<SPAN class=daohang_nonce>政策法规</SPAN>
																	</TD>
																</TR>
																<TR>
																	<TD height=1>
																			...
																			<TBODY>
																				<TR>
																					<TD width="21%"
																						...
																						&nbsp;&nbsp;
																						<A class=daohang_link
																							href="${pageContext.request.contextPath}/jsp/policy/lawSection.action?sname=${section.name }">
																							${section.name }</A>
																					</TD>
																					<TD width="79%"
																						background=${pageContext.request.contextPath}/images/m2.gif
																...
																<TBODY>
																								 	...
																								 	<TR>
																										...
																										<TD style="BORDER-BOTTOM: #999999 1px dotted"
																											...
																											<A title="标题：<%=infor.getName() %> "
																												href="${pageContext.request.contextPath}/jsp/policy/showPolicy.action?id=<%=infor.getId() %>"
																	...
																	<TR>
																		<TD height=8>
																			<DIV align=right>
																				<A
																					href="${pageContext.request.contextPath}/jsp/policy/lawSection.action?sname=${section.name }">更多…</A>&nbsp;&nbsp;
																			</DIV>
																		</TD>
																	</TR>
																</TBODY>
																...
																<TBODY>
																	<TR>
																		<TD width="21%"
																			...
																			&nbsp;&nbsp;
																			<A class=daohang_link
																				href="${pageContext.request.contextPath}/jsp/policy/lawSection.action?sname=地方法规">
																				地方法规</A>
																		</TD>
																		<TD width="79%"
																			background=${pageContext.request.contextPath}/images/m2.gif
																...
																<TBODY>
																	...
																	<TR>
																		<TD>
																			...
																			<TABLE cellSpacing=0 cellPadding=0 width="100%"
																				...
																				<TBODY>
																				<c:choose>
																				<c:when test="${!empty XYDB_INFO_localLaw }" >
																				<c:forEach var="info"items="${XYDB_INFO_localLaw}">
																					<TR>
																						<TD align=middle width="6%" height=24>
																							<IMG height=11
																								src="${pageContext.request.contextPath}/images/arrow_6.gif"
																						...
																						<TD style="BORDER-BOTTOM: #999999 1px dotted"
																							width="75%" height=24>
																							<A title=${info.name }
																								href="${pageContext.request.contextPath}/jsp/policy/showPolicy.action?id=${info.id }"
																								target=_blank>${info.name }</A>
																						</TD>
																						<TD style="BORDER-BOTTOM: #999999 1px dotted"
																							width="19%">
																							<FONT color=#999999>[${info.createdate }] (点击<FONT
																								color=#ff0000>${info.scansum }</FONT>) </FONT>
																						</TD>
																					</TR>
																					</c:forEach>
																					</c:when>
																					...
																					<TR>
																						<TD align=middle width="6%" height=24>
																							<IMG height=11 src="${pageContext.request.contextPath}/images/arrow_6.gif" width=11>
																							</TD>
																							<TD style="BORDER-BOTTOM: #999999 1px dotted"
																									width="94%" height=24>
																											暂无信息
																	...
																	<TR>
																		<TD height=8>
																			<DIV align=right>
																				<A
																					href="${pageContext.request.contextPath}/jsp/policy/lawSection.action?sname=地方法规">更多…</A>&nbsp;&nbsp;
																			</DIV>
																		</TD>
																	</TR>
																...
																<TBODY>
																	<TR>
																		<TD width="21%"
																			...
																			&nbsp;&nbsp;
																			<A class=daohang_link
																				href="${pageContext.request.contextPath}/jsp/policy/lawSection.action?sname=行业法规">
																				行业法规</A>
																		</TD>
																		<TD width="79%"
																			background=${pageContext.request.contextPath}/images/m2.gif
																...
																<TBODY>
																	...
																	<TR>
																		<TD>
																			<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
																				<TBODY>
																					<c:choose>
																						<c:when test="${!empty XYDB_INFO_industryLaw }" >
																								<c:forEach var="info"
																									items="${XYDB_INFO_industryLaw}">
																									<TR>
																										<TD align=middle width="6%" height=24>
																											<IMG height=11
																												src="${pageContext.request.contextPath}/images/arrow_6.gif"
																	...
																	<TR>
																		<TD height=8>
																			<DIV align=right>
																				<A
																					href="${pageContext.request.contextPath}/jsp/policy/lawSection.action?sname=行业法规">更多…</A>&nbsp;&nbsp;
																			</DIV>
																		</TD>
																	</TR>
