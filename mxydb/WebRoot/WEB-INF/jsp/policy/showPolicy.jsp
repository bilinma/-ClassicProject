...
<!-- saved from url=(0047)http://sxydb.yanan.gov.cn/showpolicy.asp?id=197 -->
<HTML>
	<HEAD>
		<TITLE>延安信用担保网</TITLE>
		<STYLE type=text/css>
									...
									<TD vAlign=top align=middle width=225
										...
										<TABLE cellSpacing=0 cellPadding=0 width=202 border=0>
											<TBODY>
												...
												<TR>
													<TD align=middle background=${pageContext.request.contextPath}/images/policy.gif
														height=35>
														<DIV
														...
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<TBODY>
																...
																<TR>
																	<TD height=20>
																		<DIV align=center>
																			<A href="<%=request.getContextPath() %>/jsp/policy/lawList.action?sectionid=${section.id }">${section.name }</A>
																		</DIV>
																	</TD>
																</TR>
																<TR>
											...
											<TBODY>
												...
												<TR>
													<TD vAlign=center align=middle
														background=${pageContext.request.contextPath}/images/policy_new.gif height=35>
														<DIV
															style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
															最新政策法规
														</DIV>
										...
										<TABLE id=AutoNumber5 style="BORDER-COLLAPSE: collapse"
											...
											<TBODY>
												...
												<TR>
													<TD align=middle background=${pageContext.request.contextPath}/images/policy_hot.gif
														height=35>
														<DIV
															style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 35px; HEIGHT: 35px">
															热门政策法规
																							...
																							<TBODY>
																								<TR>
																									<TD align=middle bgColor=#ffffcc height=24>
																										<FONT color=#006699>发表日期：</FONT><FONT
																											color=#ff0000>[${XYDB_INFO.createdate }]</FONT>&nbsp;&nbsp;
																										<FONT color=#006699>编辑录入：</FONT><FONT
																											color=#ff0000>[${XYDB_INFO.releaseunit }]</FONT>
																										<FONT color=#006699>&nbsp;&nbsp;阅读：</FONT><FONT
																											color=#ff0000>${XYDB_INFO.scansum}</FONT><FONT color=#006699>次</FONT>
																										&nbsp;&nbsp;【字体：
																								...
																								<TR>
																									<TD bgColor=#ffffcc height=24>
																										...
																										<A href="http://sxydb.yanan.gov.cn/showpolicy.asp?id=196">中小企业融资担保机构风险管理暂行办法</A>-->
																									</TD>
																								</TR>
																								<TR>
																									<TD bgColor=#ffffcc height=24>
		...
		<DIV align=center>
			<TABLE cellSpacing=0 cellPadding=0 width=992 border=0>
				<TBODY>
					...
					<TR>
						<TD align="center" background="" height=87>
							...
							公司地址:延安市财政局办公大楼
							<BR>
							<FONT color=#999999>页面执行时间：</FONT><FONT color=#ff0000>68,405,390.000</FONT><FONT
