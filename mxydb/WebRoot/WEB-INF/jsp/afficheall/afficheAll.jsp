...
<!-- saved from url=(0040)http://sxydb.yanan.gov.cn/afficheall.asp -->
<HTML>
	<HEAD>
		<TITLE>延安信用担保网</TITLE>
		<STYLE type=text/css>
...
BODY {
	...
	<script type="text/javascript">
		function validateNum(){
				...
				if(!(!isNaN(pagenum.value)&&pagenum.value>=0)){
					alert('输入数字非法！'+pagenum.value);
					return false;
				}
							...
							<TBODY>
								<TR>
									<TD vAlign=top align=middle width=225
										background=${pageContext.request.contextPath}/images/news-left-bg.gif height=180>
										<!--最新公告前10条显示-->
												...
												<TR>
													<TD
														...
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															...
															<!-- 	<TR>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="69%" height=22>
																		<A title=网站试运行公告
																			href="http://sxydb.yanan.gov.cn/showAff.asp?id=51"
																			target=_blank>&nbsp;·网站试运行公告</A>
																	</TD>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="30%">
																		2008-4-20
																...
																<TR>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="69%" height=22>
																		<A title=关于受理社会各界对延安市中小企业信用担保有限责任公司担保贷款监督举报的公告
																			href="http://sxydb.yanan.gov.cn/showAff.asp?id=59"
																			target=_blank>&nbsp;·关于受理社会各界…</A>
																	</TD>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="30%">
																		2008-8-26
																...
																<TR>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="69%" height=22>
																		<A title=人员招聘公告
																			href="http://sxydb.yanan.gov.cn/showAff.asp?id=82"
																			target=_blank>&nbsp;·人员招聘公告</A>
																	</TD>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="30%">
																		2008-9-18
																...
																<TR>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="69%" height=22>
																		<A title=关于受理社会各界对延安市中小企业信用担保有限责任公司担保贷款监督举报的公告
																			href="http://sxydb.yanan.gov.cn/showAff.asp?id=83"
																			target=_blank>&nbsp;·关于受理社会各界…</A>
																	</TD>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="30%">
																...
																<TR>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="69%" height=22>
																		<A title=关于受理社会各界对延安市中小企业信用担保有限责任公司担保贷款监督举报的公告
																			href="http://sxydb.yanan.gov.cn/showAff.asp?id=84"
																			target=_blank>&nbsp;·关于受理社会各界…</A>
																	</TD>
																	<TD style="BORDER-BOTTOM: #cccccc 1px dashed"
																		align=left width="30%">
										...
										<!--最新公告结束-->
										<!--公告搜索-->
										<FORM name=form1 action="selectAffiche.action" method=post>
															...
															<TBODY>
																<TR>
																	<TD align=middle height=24>
																		&nbsp;&nbsp;
																		<INPUT class=input size=28 name=affichename value="${affichename }">
																	</TD>
																</TR>
																<TR>
																	<TD height=24>
												...
												<TR>
													<TD vAlign=top height=206>
															...
															<TBODY>
																<TR>
																	<TD background=${pageContext.request.contextPath}/images/menu2bg.gif height=32>
																		&nbsp;&nbsp;&nbsp;
																		<IMG height=10 src="${pageContext.request.contextPath}/images/icon3.gif"
																			width=10>
																		&nbsp;当前位置：
																		<A class=daohang_link
																			href="<%=request.getContextPath() %>/jsp/main.action">网站首页</A>&nbsp;&gt;&gt;&nbsp;
																		<SPAN class=daohang_nonce>网站公告</SPAN>
																	</TD>
																</TR>
															</TBODY>
														</TABLE>
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<TBODY>
																<c:choose>
																<c:when test="${!empty  XYDB_AFFICHES}" >
																<c:forEach var="info" items="${XYDB_AFFICHES}">
																<TR>
																	...
																	<TD style="BORDER-BOTTOM: #999999 1px dotted"
																		...
																		<A title="标题：${info.name }"
																			href="${pageContext.request.contextPath}/jsp/afficheeall/showAff.action?id=${info.id }"
																...
																<TR vAlign=bottom>
																	<TD align=middle colSpan=3 height=50>
																		<FORM
																			action=${pageContext.request.contextPath}/jsp/afficheall/afficheAll.action?
																			method=post>
																			${pagenav }
																			<B>20</B>条记录/页 
																			<!--  转到：
																			<INPUT class=input maxLength=10 size=4 value=1
																				name=page >
																			<INPUT class=input type=submit value=" Goto "
																				name=cndok onclick="validateNum()">-->
																			<P></P>
																		</FORM>
																	</TD>
																</TR>
																...
																<c:otherwise>
																	<TR>
																		...
																		<TD style="BORDER-BOTTOM: #999999 1px dotted" width="94%" height=24>
																			暂无信息
																		</TD>
																	</TR>
																</c:otherwise>
				...
				<TBODY>
					...
					<TR>
						<TD align=middle background="" height=87>
							...
							公司地址:延安市财政局办公大楼
							<BR>
							<FONT color=#999999>页面执行时间：</FONT><FONT color=#ff0000>44,825,280.000</FONT><FONT
