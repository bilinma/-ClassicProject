...
<!-- saved from url=(0054)http://sxydb.yanan.gov.cn/operation.asp?title=业务范围 -->
<HTML>
	<HEAD>
		<TITLE>延安信用担保网</TITLE>
		<STYLE type=text/css>
									...
									<TR>
										...
										<TD vAlign=center align=left width=72>
											<A
												...
												href="${pageContext.request.contextPath}/jsp/operation/operationIndex.action?mname=业务内容"><SPAN
									...
									<TD vAlign=top align=middle width=225
										...
										<TABLE cellSpacing=0 cellPadding=0 width=202 border=0>
											<TBODY>
												...
												<TR>
													<TD align=middle background=${pageContext.request.contextPath}/images/operation.gif
														height=35>
														<DIV
														...
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<TBODY>
																...
																<TR>
																	<TD height=20>
																		<DIV align=center>
																			<A href="<%=request.getContextPath() %>/jsp/operation/operationList.action?sectionid=${section.id }">${section.name }</A>
																		</DIV>
																	</TD>
																</TR>
																<TR>
															...
															<TBODY>
																<TR>
																	<TD background=${pageContext.request.contextPath}/images/menu2bg.gif height=32>
																		...
																		<A class=daohang_link
																			href="${pageContext.request.contextPath}/jsp/operation/operationIndex.action">业务内容</A>&gt;&gt;&nbsp;
																		<SPAN class=daohang_nonce>${SectionName }</SPAN>
																	</TD>
																</TR>
																<!--<tr><td><div align="center"><img src="images/ad_operation.jpg"></div></td></tr>-->
																<!--正文区-->
																<TR>
																	<TD height=2></TD>
																</TR>
																	...
																	<TD vAlign=top align=middle>
																		<TABLE cellSpacing=0 cellPadding=0 width="98%"
																			...
																			<TBODY>
																				...
																				<%List<Information> informations=(List<Information>)session.getAttribute("XYDB_LISTINFO");
																						...
																						<TR>
																							<TD>
																								<FONT face=Verdana>
																									<FONT face=Verdana><B>
																										<FONT color=#00008b>
																										<FONT face=Verdana><P>暂无信息</P></FONT>
																										</FONT></B>
																									</FONT>
																								</FONT>
																							</TD>
																						</TR>
																				<% 	 }else if(informations.size()==1){
																					...
																					<TR>
																						...
																						<TD style="BORDER-BOTTOM: #999999 1px dotted"
																							...
																							<A title="标题：${info.name }"
																								href="${pageContext.request.contextPath}/jsp/news/showOperation.action?id=${info.id }"
