    ...
    a.extend(a.jqx._jqxGrid.prototype, {
        _initpager: function() {
            ...
            if (!this.pagerrenderer) {
                ...
                this.pagergotoinput = this.pagergotoinput || a('<div style="margin-right: 12px; width: 27px; height: 20px; float: right;"><input style="margin-top: 0px; text-align: right; height:20px; width: 27px;" type="text"/></div>');
