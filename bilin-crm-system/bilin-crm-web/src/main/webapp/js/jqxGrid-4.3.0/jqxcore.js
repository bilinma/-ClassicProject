...
(function(f) {
      ...
      h.extend({
            ...
            Event: function(k, q) {
                  var t = this;
                  var j, m, r, w, o, n, u, s, p, x, v = k.type || k,
                        l = [];
                  if (v.indexOf(".") >= 0) {
                        l = v.split(".");
                        v = l.shift();
            ...
            sizeStyleChanged: function(l) {
                  ...
                  m = {
                        element: k.element,
                        offsetWidth: k.element.offsetWidth,
                        offsetHeight: k.element.offsetHeight,
                        callback: l
                  };
                  if (!k.elementStyleObserver) {
                        k.elementStyleObserver = new MutationObserver(j);
                        k.elementStyleObserver.observe(k.element, {
                              attributes: true,
                              childList: false,
                              characterData: false
                        })
            ...
            sizeChanged: function(l) {
                  ...
                  if (!k.observer) {
                        ...
                        k.elementObserver.observe(k.element, {
                              attributes: true,
                              childList: true,
                              characterData: true
                        })
            ...
            html: function(v) {
                  ...
                  try {
                        ...
                        var n = /<(?:script|style|link)/i,
                              j = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
                              q = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
                              m = /<([\w:]+)/,
                              C = /<(?:script|object|embed|option|style)/i,
                              r = new RegExp("<(?:" + j + ")[\\s/>]", "i"),
                              A = /^\s+/,
                              u = {
            ...
            boxModel: function(k, j, p) {
                  ...
                  var m = this;
                  var l = j === (p ? "border": "content") ? 4 : k === "width" ? 1 : 0,
                        o = 0;
                  for (; l < 4; l += 2) {
                        if (j === "margin") {
                              o += m.css(j + n[l], true)
            ...
            css: function(k) {
                  ...
                  if (f.getComputedStyle) {
                        j = function(w, q) {
                              var p, t, s, v, u = f.getComputedStyle(w, null),
                                    r = w.style;
                              if (u) {
                        ...
                        if (document.documentElement.currentStyle) {
                              j = function(t, r) {
                                    var u, p, q = t.currentStyle && t.currentStyle[r],
                                          s = t.style;
                                    if (q == null && s && s[r]) {
                                          q = s[r]
                                    }
            ...
            offset: function(o) {
                  ...
                  if (o) {
                        ...
                        var C = A,
                              ...
                              n = A.style.top,
                              x = A.style.left,
                              p = ((E === "absolute" || E === "fixed") && (n === "auto" || x === "auto")),
                              m = {},
                              t = {},
                              l,
                              r;
                  ...
                  return {
                        top: k + v.top + (q.pageYOffset || B.scrollTop) - (B.clientTop || 0),
                        left: y + v.left + (q.pageXOffset || B.scrollLeft) - (B.clientLeft || 0)
                  }
            },
            position: function() {
                  var m = this;
                  ...
                  offset = m.offset(),
                        parentOffset = j.test(k.nodeName) ? {
                              top: 0,
                              left: 0
                        }: k.offset();
            ...
            contains: function(k, j) {
                  var m = k.nodeType === 9 ? k.documentElement: k,
                        l = j && j.parentNode;
            ...
            initAnimate: function() {
                  ...
                  var s = (function() {
                        var F = 0;
                        return f.requestAnimationFrame || f.webkitRequestAnimationFrame || f.mozRequestAnimationFrame ||
                              function(I) {
                  ...
                  var z = (function() {
                        ...
                        function I(O, M) {
                              var K = {
                                    ...
                                    Q = F(O, M * 0.5, J),
                                    P = F(O, M, Q),
                                    N = 1 / 6 * (K.dx + 2 * (J.dx + Q.dx) + P.dx),
                                    L = 1 / 6 * (K.dv + 2 * (J.dv + Q.dv) + P.dv);
                              O.x = O.x + N * M;
                              O.v = O.v + L * M;
                              return O
                        }
                  ...
                  var n = function() {
                        ...
                        var M = (arguments[0] && (arguments[0].p || ((q.isPlainObject(arguments[0].properties) && !arguments[0].properties.names) || t.isString(arguments[0].properties)))),
                              P,
                              F,
                              G;
                        var N, Q, J;
                                    ...
                                    q.each(N,
                                          function(ab, aa) {
                                                ...
                                                if (Q === "finishAll" && (J === true || t.isString(J))) {
                                                      q.each(q.queue(aa, t.isString(J) ? J: ""),
                                                            function(ac, ad) {
                                                                  if (t.isFunction(ad)) {
                                                                        ad()
                                                                  }
                                                                        ...
                                                                        function(af, ag) {
                                                                              if (ag === ad) {
                                                                                    if (J === true || t.isString(J)) {
                                                                                          q.each(q.queue(ag, t.isString(J) ? J: ""),
                                                                                                function(ah, ai) {
                                                                                                      if (t.isFunction(ai)) {
                                                                                                            ai(null, true)
                                                                                                      }
                                          ...
                                          if (t.isString(Q) && E.Redirects[Q]) {
                                                ...
                                                q.each(N,
                                                      function(ab, aa) {
                                                            ...
                                                            E.Redirects[Q].call(aa, aa, O || {},
                                                                  ab, Z, N, promiseData.promise ? promiseData: undefined)
                                                      });
                                                return H()
                                          } else {
                              ...
                              function ae(ao) {
                                    ...
                                    if (S === "start") {
                                          ...
                                          for (var av in Q) {
                                                ...
                                                function ah(ay, ax) {
                                                      var aw, az;
                                                      az = (ax || "0").toString().toLowerCase().replace(/[%A-z]+$/,
                                                            function(aA) {
                                                                  aw = aA;
                                                                  return ""
                                                            });
                                    ...
                                    for (var S = 0,
                                          ...
                                          for (var K in Q) {
                                                if (K !== "element") {
                                                      var I = Q[K],
                                                            N,
                                                            R = t.isString(I.easing) ? E.Easings[I.easing] : I.easing;
                                                      if (W === 1) {
                                                            N = I.endValue
                                                      } else {
      ...
      h.extend(c, {
            ...
            trigger: function(k, r, p, z) {
                  ...
                  var j, m, s, x, o, n, v, t, q, y, w = k.type || k,
                        l = [];
                  if (w.indexOf(".") >= 0) {
                        l = w.split(".");
                        w = l.shift();
            ...
            dispatch: function(y, k) {
                  ...
                  var o = this;
                  y = c.createEvent(y);
                  var A, x, q, B, z, s, n, l, w, C, u = ((r.data(o, "events") || {})[y.type] || []),
                        t = u.delegateCount,
